...
public class ReviewTest extends BaseTest {
    ...
    public void testCase_MPD_08(String baseURL) throws InterruptedException {
       // objRegist.acceptAllCookies();
        reviewPage.CheckTheHelpfulFunction(baseURL +"glamira-diamonds-ring-madison-skug100620.html?alloy=white-585&stone1=diamond-Brillant&stone2=diamond-Brillant",false);
    }
    ...
    @Parameters("baseURL")
    @Test(priority = 11,description = "Check the \"Write a review\" function in the product view of the item that is not in the Item To review section")
    ...
    @Parameters("baseURL")
    @Test(priority = 12,description = "Check the \"Write a review\" function in the product view of the item that in the Item To review section")
    ...
    @Parameters("baseURL")
    @Test(priority = 13,description = "Check function button SHOW MORE of pages ")
    ...
    @Parameters("baseURL")
    @Test(priority = 14,description = "Check the review translation function ")
    ...
    @Parameters("baseURL")
    @Test(priority = 15,description = "check lazy load of translation ")
