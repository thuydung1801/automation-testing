...
//    }
    ...
    @Test (priority = 19, description = "ORDER A FREE RING SIZER - enter correct values")
    public void testCase_NPP_01() throws InterruptedException {
        testProductDetail.newNPP01();
    }
    @Test (priority = 20, description = "ORDER A FREE RING SIZER - enter correct values")
    public void testCase_NPP_02() throws InterruptedException {
        testProductDetail.newNPP02();
    }
    @Test (priority = 21, description = "ORDER A FREE RING SIZER - enter correct values")
    public void testCase_NPP_03() throws InterruptedException {
        testProductDetail.newNPP03();
    }
    @Test (priority = 22, description = "ORDER A FREE RING SIZER - enter correct values")
    public void testCase_NPP_04() throws InterruptedException {
        testProductDetail.newNPP04();
    }
    @Test (priority = 23, description = "ORDER A FREE RING SIZER - enter correct values")
