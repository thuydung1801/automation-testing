...
public class LoginToAdminPages extends CommonPage {
    ...
    public void LoginAdmin(String isValid) {
        ...
        if (isValid.equalsIgnoreCase("valid")) {
            email = TestDataService.properties.getProperty("username");
            password = TestDataService.properties.getProperty("pass");
        } else {
            email = TestDataService.properties.getProperty("wrongUsername");
            password = TestDataService.properties.getProperty("wrongPasswordadmin");
        }
