...
public class RunnerGenerator {
    public static void main(String[] args) throws IOException {
        final File folder = new File("src/test/resources/features/consult_mektoube_page");
